...
<div class="container mt-3">
    ...
    <form id="frm-selection" action="<?= base_url('admin/Machine_setting/update_selection') ?>" method="post">
        <div class="row mt-4 mb-5">
            ...
            <div class="col-md-12">
                <h4><i class="fa fa-caret-right fa-lg"></i>Cocoon</h4>
                <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" role="switch" id="cocoon" name="cocoon" <?= ($selection[0]->cocoon == 1) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="isaver_mode_1">Open</label>
                </div>
